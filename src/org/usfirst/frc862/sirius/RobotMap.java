...
public class RobotMap {
    ...
    public static void init() {
        ...
        LiveWindow.addActuator("DriveTrain", "Left 1", (VictorSP) driveTrainLeft1);
        driveTrainLeft1.setInverted(true);
        driveTrainLeft2 = new VictorSP(2);
        LiveWindow.addActuator("DriveTrain", "Left 2", (VictorSP) driveTrainLeft2);
        driveTrainLeft2.setInverted(true);
        driveTrainRight1 = new VictorSP(0);
        LiveWindow.addActuator("DriveTrain", "Right 1", (VictorSP) driveTrainRight1);
        driveTrainRight1.setInverted(false);
        driveTrainRight2 = new VictorSP(1);
        LiveWindow.addActuator("DriveTrain", "Right 2", (VictorSP) driveTrainRight2);
